(function(d) {
    ...
    e.prototype.generateHTMLForEntries = function() {
        ...
        d(this.entries).each(function() {
            ...
            c && f ? index >= c && index <= f && a.isRelevant(this, b.entries) && (c = a.evaluateStringForEntry(a.options.entryTemplate, this), b.entries.push(c)) : a.isRelevant(this, b.entries) && (c = a.evaluateStringForEntry(a.options.entryTemplate,
                this), b.entries.push(c))
        });
    ...
    e.prototype.getTokenMap = function(a) {
        ...
        return d.extend({
            ...
            url: a.link,
            author: a.author,
            date: moment(a.publishedDate).format(this.options.dateFormat),
            title: a.title,
            body: a.content,
            shortBody: a.contentSnippet,
            bodyPlain: function(a) {
                for (var a = a.content.replace(/<script[\\r\\\s\S]*<\/script>/mgi,
                    "").replace(/<\/?[^>]+>/gi, ""), b = 0; b < e.htmlTags.length; b++) a = a.replace(RegExp("<" + e.htmlTags[b], "gi"), "");
                return a
            }(a),
